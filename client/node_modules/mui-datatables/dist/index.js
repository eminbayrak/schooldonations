...
var _excluded$4=["fixedHeader","fixedSelectColumn","isHeaderCell","expandableOn","selectableOn","isRowExpanded","onExpand","isRowSelectable","selectableRowsHeader","hideExpandButton","expandableRowsHeader","expandedRows","areAllRowsExpanded","selectableRowsHideCheckboxes","setHeadCellRef","dataIndex","components"];var useStyles$9=styles.makeStyles((function(e){return {root:{"@media print":{display:"none"}},fixedHeader:{position:"sticky",top:"0px",zIndex:100},fixedLeft:{position:"sticky",left:"0px",zIndex:100},icon:{cursor:"pointer",transition:"transform 0.25s"},expanded:{transform:"rotate(90deg)"},hide:{visibility:"hidden"},headerCell:{zIndex:110,backgroundColor:e.palette.background.paper},expandDisabled:{},checkboxRoot:{},checked:{},disabled:{}}}),{name:"MUIDataTableSelectCell"}),TableSelectCell=function(e){var o,t,d,a=e.fixedHeader,l=e.fixedSelectColumn,r=e.isHeaderCell,n=void 0!==r&&r,i=e.expandableOn,s=void 0!==i&&i,p=e.selectableOn,c=void 0===p?"none":p,x=e.isRowExpanded,b=void 0!==x&&x,f=e.onExpand,m=e.isRowSelectable,u=e.selectableRowsHeader,y=e.hideExpandButton,h=e.expandableRowsHeader,R=e.expandedRows,C=e.areAllRowsExpanded,P=void 0===C?function(){return !1}:C,w=e.selectableRowsHideCheckboxes,k=e.setHeadCellRef,E=e.dataIndex,_=e.components,H=void 0===_?{}:_,T=_objectWithoutProperties__default['default'](e,_excluded$4),S=useStyles$9(),v=H.Checkbox||Checkbox__default['default'],I=H.ExpandButton||ExpandButton;if(!1===s&&("none"===c||!0===w))return null;var g=clsx__default['default']((_defineProperty__default['default'](o={},S.root,!0),_defineProperty__default['default'](o,S.fixedHeader,a&&n),_defineProperty__default['default'](o,S.fixedLeft,l),_defineProperty__default['default'](o,S.headerCell,n),o)),j=clsx__default['default'](_defineProperty__default['default']({},S.expandDisabled,y)),B=clsx__default['default']((_defineProperty__default['default'](t={},S.icon,!0),_defineProperty__default['default'](t,S.hide,n&&!h),_defineProperty__default['default'](t,S.expanded,b||n&&P()),t)),O=clsx__default['default']((_defineProperty__default['default'](d={},S.icon,!0),_defineProperty__default['default'](d,S.hide,n&&!h),d)),z={};k&&(z.ref=function(e){k(0,0,e);});return React__default['default'].createElement(TableCell__default['default'],_extends__default['default']({className:g,padding:"checkbox"},z),React__default['default'].createElement("div",{style:{display:"flex",alignItems:"center"}},s&&React__default['default'].createElement(I,{isHeaderCell:n,areAllRowsExpanded:P,expandedRows:R,onExpand:f,expandableRowsHeader:h,buttonClass:j,iconIndeterminateClass:O,iconClass:B,dataIndex:E}),"none"!==c&&!0!==w&&(!n||"multiple"===c&&!1!==u?React__default['default'].createElement(v,_extends__default['default']({classes:{root:S.checkboxRoot,checked:S.checked,disabled:S.disabled},"data-description":n?"row-select-header":"row-select","data-index":E||null,color:"primary",disabled:!m},T)):null)))};TableSelectCell.propTypes={checked:PropTypes__default['default'].bool.isRequired,fixedHeader:PropTypes__default['default'].bool,onChange:PropTypes__default['default'].func,classes:PropTypes__default['default'].object,expandableOn:PropTypes__default['default'].bool,hideExpandButton:PropTypes__default['default'].bool,selectableOn:PropTypes__default['default'].string,isRowSelectable:PropTypes__default['default'].bool};
